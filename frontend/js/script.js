...
const axiosInstance = axios.create({
    baseURL: "http://3.27.133.80:4000/expense",
    headers : {
...
async function renderElements() {
    ...
    let res = await axios.get('http://3.27.133.80:4000/premium/checkPremium',{
        headers : {
            "auth-token" : localStorage.getItem('token')
        },
...
async function purchaseMembeship(e) {
    ...
    try {
        ...
        const response = await axios.post('http://3.27.133.80:4000/payment/purchasemembership', null, {
            headers: {
                "auth-token": localStorage.getItem('token')
            },
        ...
        var options = {
            ...
            "handler": async function (response) {
                const res = await axios.post("http://3.27.133.80:4000/payment/success", {
        ...
        //     const res = await axios.get("http://3.27.133.80:4000/payment/external", {
        //     headers: {
        //         "auth-token": localStorage.getItem('token')
        //     }
        // })
        ...
        rzp1.on('payment.failed', async function (response) {
            ...
            const res = await axios.post("http://3.27.133.80:4000/payment/failed", {
...
document.getElementById("showleaderboard").addEventListener('click', async()=>{
    try{
        const res = await axios.get('http://3.27.133.80:4000/premium/showleaderboard',{
            headers :{
                "auth-token": localStorage.getItem('token')
            }
